...
public class CrearPregunta extends AppCompatActivity {
        ...
        btncrearPregunta.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(     Pregunta.isEmpty() ||
                    ...
                    Toast.makeText(CrearPregunta.this, "Rellene todos los campos", Toast.LENGTH_SHORT).show();
                }
                else{
    ...
    private void iniciarDeteccion() {
        ...
        try {
            ...
            Toast.makeText(CrearPregunta.this, "Error al Reconocer", Toast.LENGTH_SHORT).show();
        }
    }
    @Override
    ...
    private void InsertarPregunta(String Pregunta, String altercorrecta, String alterincorrecta1, String alterincorrecta2, String alterincorrecta3, String Retroalimentacion, String puntaje) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                Intent intent = new Intent(CrearPregunta.this, PreguntasFragment.class);
                Toast.makeText(CrearPregunta.this, "Registro Exitoso", Toast.LENGTH_LONG).show();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(CrearPregunta.this, "error " + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
